...
| `test_version` | constante | `0.2.0` |

`test_version` atual `0.2.0` identifica a versao com protocolo curto, HUD e tema escuro. Os campos do formulario de sessao permanecem inalterados.
...
- O CSV oficial usa `participant_id` como nome-base do arquivo; demais metadados ficam no conteudo do CSV local.
